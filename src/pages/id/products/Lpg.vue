  ...
  <ID>
    <section>
      ...
      >
        ...
        >
          <div class="uppercase text-white">Tentang LPG</div>
        </div>
      </div>
    </section>
          ...
          >
            ...
            <div class="m-3 pt-16">
              ...
              >
                Berat Neto 50kg <br />
                <br />
                Untuk Restaurant dan usaha kecil menengah<br />
                <br />
              </p>
    ...
    <section class="bg-white py-10">
      <div class="container mt-4 mx-auto">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="col-span-2 justify-self-center">
            <h1 class="lg:text-6xl text-3xl font-bold">LPG</h1>
            <p align="justify" class="px-30">
              LPG mempunyai dampak yang besar terhadap bidang FnB di Indonesia.
              Kami Menyediakan berbagai macam varian LPG untuk memenuhi
              kebutuhan industri FnB maupun kebutuhan primer dalam rumah
              tangga.<br />
              <br />
              Bisnis LPG PT.Aspindo saat ini telah menyentuh tahun ke 4 dan akan
              tetap melayani anda dengan maksimal.
            </p>
          </div>
        </div>
      </div>
