  ...
  <ID>
    <section>
      ...
      >
        ...
        >
          <div class="uppercase text-white">Tentang Seafood</div>
        </div>
      </div>
    </section>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="col-span-2 justify-self-center">
            ...
            <p align="justify" class="px-30">
              ...
              <br />
              <br />
              <span class="text-red-700 font-bold pr-3">
                Stay Tune for More!</span
              >
              <span class="text-gray-900 font-semibold"> ATAU </span>
              <a
